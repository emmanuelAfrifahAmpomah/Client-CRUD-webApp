...
<body class="bg-secondary">
    <div class="container container-lg-fluid container-md container-sm container-xs mt-xs-5 mt-sm-5 mt-md-5">
      <div class="row">
        <!-- <div class="col col-md-60 col-xs-4">
          <div class="contents"> -->
            <h1 class="text-center center">List of Clients</h1>
            <div>
            <a href="add.php" class="btn btn-lg btn-primary mb-3 d-grid">Add new client</a>
